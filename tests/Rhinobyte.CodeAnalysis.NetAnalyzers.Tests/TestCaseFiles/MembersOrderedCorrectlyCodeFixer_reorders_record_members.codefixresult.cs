...
{
	public record ExampleRecord1(string Alpha, string Bravo, string Charlie, string Delta);
	...
	public readonly record struct ExampleRecord4(string Alpha, string Bravo, string Charlie, string Delta);
	...
	{
		public record ExampleRecord6(string Alpha, string Bravo, string Charlie, string Delta);
